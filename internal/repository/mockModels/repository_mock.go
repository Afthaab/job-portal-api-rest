...
//
//	mockgen -source=repository.go -destination=mockModels/repository_mock.go -package=mockrepository
//
...
func (m *MockUserRepo) CreateJob(ctx context.Context, jobData models.Jobs) (models0.ResponseNewJobs, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepo) GetTheJobData(jobid uint) (models.Jobs, error) {
	m.ctrl.T.Helper()
